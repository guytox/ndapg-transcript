...
class CreateComputedResultsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('computed_results', function (Blueprint $table) {
            ...
            $table->string('computed_at')->nullable();
            $table->string('eo_approved_at')->nullable();
            $table->string('hod_approved_at')->nullable();
            $table->string('dean_approved_at')->nullable();
            $table->string('committee_approved_at')->nullable();
            $table->string('senate_approved_at')->nullable();
