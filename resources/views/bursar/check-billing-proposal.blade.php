            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    {{-- <a href="{{ route('presenting.create')  }}" class="btn btn-primary">Add new Presentation topic &nbsp; <i--}} {{--                                    class="mdi mdi-file-document-edit-outline"></i></a>--}} {{--                        </div>--}} </div>
                        ...
                        <a href="{{route('billing.confirm.action')}}" class="btn btn-danger">Confirm Billing</a>
                        @endrole

                        @role('check_payment|admin')
                        <a href="{{route('billing.check.action')}}" class="btn btn-danger">Confirm Check Billing</a>
                        @endrole

                        @role('bursar|admin')
                        <a href="{{route('billing.approve.action')}}" class="btn btn-danger">Approve Billing</a>
                        @endrole
                        <br>
                        <br>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('delete.bill.proposal',['id'=>$v['bill_id']])}}" class="btn btn-danger">Delete</a>
                                        @endrole

                                        @role('upload_payment|check_payment|admin')
                                        <a href="{{route('reverse.bill.proposal',['id'=>$v['bill_id']])}}" class="btn btn-danger">Disapprove</a>
                                        @endrole
