...
<div class="card">
        ...
        <h4 class="mt-0 mb-4">Result Computation Form (Select Result to Compute Here)</h4>
            {!! Form::open(['route' => ['result-compute-home', 'as'=>'ityoughKiKyaren'], 'method' => 'POST']) !!}
            ...
            {!! Form::submit('Check Readiness',['class'=>'btn btn-warning form-control']) !!}
