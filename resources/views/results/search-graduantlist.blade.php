...
<div class="card">
        ...
        <h4 class="mt-0 mb-4">To Check Recommeded Graduants (Select Programme,  Session and Semester)</h4>
            {!! Form::open(['route' => ['get.graduation.summary', 'as'=>'ityoughKiKyaren'], 'method' => 'POST']) !!}
            ...
            {!! Form::submit('Retrieve Recommeded Graduants',['class'=>'btn btn-danger form-control']) !!}
