            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    {{-- <a href="{{ route('presenting.create')  }}" class="btn btn-primary">Add new Presentation topic &nbsp; <i--}} {{--                                    class="mdi mdi-file-document-edit-outline"></i></a>--}} {{--                        </div>--}} </div>
                        ...
                        @role('admin')
                        <a href="{{route('reverse.migration')}}" class="btn btn-danger">Reverse Student Migration</a>
                        @endrole
                        <br>
                        <br>
                        ...
                        @role('admin')
                        <a href="{{route('reverse.migration')}}" class="btn btn-danger">Approve Student Migration</a>
                        @endrole
