...
<h4 class="mt-0 mb-4">View Registered Students Report</h4>
<div class="row">
    <div class="card ">
        <div class="card-body">

            {!! Form::open(['route' => 'show.registered.students', 'method' => 'POST']) !!}
            ...
            {!! Form::submit('View Registered Students', ['class'=>'form-control btn btn-success']) !!}
