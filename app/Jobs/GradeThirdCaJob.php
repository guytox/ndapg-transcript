...
class GradeThirdCaJob implements ShouldQueue
{
     ...
     * @return void
     */
    public function __construct($gradeCourse,$gradeSession,$gradeSemester,$gradeStaff, $grading, $allocationUid, $matric, $time, $ca3)
    {
            ...
            if ($semesterCourse) {
                ...
                if ($monitorItem) {
                    ...
                    if ($monitorItem->status == 'approved') {
                        ...
                        $caTotal = $this->ca3 + convertToNaira($monitorItem->ca1) + convertToNaira($monitorItem->ca2) + convertToNaira($monitorItem->ca4);
                        #check to see if this addition will not cause problem
                        if ($caTotal <= $semesterCourse->max_ca) {
                            #this entry is valid, check to see if there is a difference in ca3 then ignore the change request completely
                            if ($this->ca3 != convertToNaira($monitorItem->ca3)) {
                                ...
                                Log::info("ca3 Score of ". $this->ca3 . " for ". $semesterCourse->courseCode. " Entered Successfully for " . $this->matric);
                                ...
                                $data =[
                                    ...
                                    'changes' => "[CA3]",
                                    'old_values' => '['.convertToBoolean($this->ca3).']',
                                ...
                                Log::info("No differnce in ca3 found for grading of ". $semesterCourse->courseCode. " for ". $this->matric. " Skipping ....");
                            }


                        }else {
                            Log::info("ca3 Grading of ". $semesterCourse->courseCode . "for " . $this->matric . " Failed  because max CA Score has been exceeded .......");
                        }
