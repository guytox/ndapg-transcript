...
class GradeFourthCaJob implements ShouldQueue
{
     ...
     * @return void
     */
    public function __construct($gradeCourse,$gradeSession,$gradeSemester,$gradeStaff, $grading, $allocationUid, $matric, $time, $ca4)
    {
            ...
            if ($semesterCourse) {
                ...
                if ($monitorItem) {
                    ...
                    if ($monitorItem->status == 'approved') {
                        ...
                        $caTotal = $this->ca4 + convertToNaira($monitorItem->ca1) + convertToNaira($monitorItem->ca2) + convertToNaira($monitorItem->ca3);
                        #check to see if this addition will not cause problem
                        if ($caTotal <= $semesterCourse->max_ca) {
                            #this entry is valid, check to see if there is a difference in ca4 then ignore the change request completely
                            if ($this->ca4 != convertToNaira($monitorItem->ca4)) {
                                ...
                                Log::info("ca4 Score of ". $this->ca4 . " for ". $semesterCourse->courseCode. " Entered Successfully for " . $this->matric);
                                ...
                                $data =[
                                    ...
                                    'changes' => "[CA4]",
                                    'old_values' => '['.convertToBoolean($this->ca4).']',
                                ...
                                Log::info("No differnce in ca4 found for grading of ". $semesterCourse->courseCode. " for ". $this->matric. " Skipping ....");
                            }


                        }else {
                            Log::info("ca4 Grading of ". $semesterCourse->courseCode . "for " . $this->matric . " Failed  because max CA Score has been exceeded .......");
                        }
