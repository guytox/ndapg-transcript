...
class ConfirmFirstTuitionFeePaymentJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        if ($feePayment ) {
            if ($feePayment->payment_status == 'paid') {
                if ($feePayment->config->feeCategory->payment_purpose_slug == 'first-tuition') {
                    ...
                    Log::info('First Tuition Fee Confirmation Successful for - '.$feePayment->user->username);
